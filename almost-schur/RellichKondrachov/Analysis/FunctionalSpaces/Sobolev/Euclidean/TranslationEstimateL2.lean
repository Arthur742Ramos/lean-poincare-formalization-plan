...
public import RellichKondrachov.Analysis.FunctionalSpaces.Sobolev.Euclidean.Translation
public import RellichKondrachov.Analysis.FunctionalSpaces.Sobolev.Euclidean.TranslationEstimate
...
abbrev vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ := (volume.restrict (Icc (0 : ℝ) 1))

lemma vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI_univ : (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) Set.univ = (1 : ℝ≥0∞) := by
  simp [vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI, Measure.restrict_apply, Real.volume_Icc]

lemma vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_holderConj_two_two : (2 : ℝ).HolderConjugate (2 : ℝ) := by
  refine (Real.holderConjugate_iff).2 ?_
  constructor
  · linarith
  · norm_num

lemma vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_lintegral_rpow_two_le_lintegral_rpow_two
    {g : ℝ → ℝ≥0∞} (hg : AEMeasurable g (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) :
    (∫⁻ t, g t ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ^ (2 : ℝ) ≤ ∫⁻ t, g t ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) := by
  -- Hölder with `g * 1` gives `∫ g ≤ (∫ g^2)^(1/2) * (∫ 1^2)^(1/2)`.
  have hHolder :
      (∫⁻ t, g t ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ≤
        (∫⁻ t, g t ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ^ (1 / (2 : ℝ)) *
          (∫⁻ _t : ℝ, (1 : ℝ≥0∞) ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ^ (1 / (2 : ℝ)) := by
    simpa [Pi.mul_apply] using!
      (ENNReal.lintegral_mul_le_Lp_mul_Lq (μ := (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_holderConj_two_two
        hg (aemeasurable_const : AEMeasurable (fun _t : ℝ => (1 : ℝ≥0∞)) (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)))
  have h1 : (∫⁻ _t : ℝ, (1 : ℝ≥0∞) ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ^ (1 / (2 : ℝ)) = (1 : ℝ≥0∞) := by
    -- `vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI` has total mass `1`, and `1^2 = 1`.
    simp
  have h :
      (∫⁻ t, g t ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ≤
        (∫⁻ t, g t ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ^ (1 / (2 : ℝ)) := by
  ...
  simpa [ENNReal.rpow_mul] using! (h'.trans_eq (by
    ...
    simpa [this] using!
      (ENNReal.rpow_mul
        (∫⁻ t, g t ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ))
        (1 / (2 : ℝ)) (2 : ℝ)).symm))
    ...
    have hsq :
      ...
      have hpt :
          ∀ x : E,
            ‖f.1 (x + a) - f.1 x‖ₑ ^ (2 : ℝ) ≤
              ‖a‖ₑ ^ (2 : ℝ) *
                ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) := by
        intro x
        ...
        have h1 :
            ‖f.1 (x + a) - f.1 x‖ₑ ^ (2 : ℝ) ≤
              (‖a‖ₑ * ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ^ (2 : ℝ) := by
          exact ENNReal.rpow_le_rpow h0 (by norm_num)
        have hcs :
            (∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ^ (2 : ℝ) ≤
              ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) := by
          refine vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_lintegral_rpow_two_le_lintegral_rpow_two (g := fun t : ℝ =>
        ...
        calc
          ‖f.1 (x + a) - f.1 x‖ₑ ^ (2 : ℝ)
              ≤ (‖a‖ₑ * ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ^ (2 : ℝ) := h1
          _ = ‖a‖ₑ ^ (2 : ℝ) *
              (∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ
                ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) ^ (2 : ℝ) := by
              simpa using!
                (ENNReal.mul_rpow_of_nonneg ‖a‖ₑ
                  (∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ
                    ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ))
                  (show (0 : ℝ) ≤ (2 : ℝ) by norm_num))
          _ ≤ ‖a‖ₑ ^ (2 : ℝ) *
              ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ)
                ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) := by
              gcongr
          _ = ‖a‖ₑ ^ (2 : ℝ) *
              ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ)
                ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) := rfl
      -- Integrate over `x` and apply Tonelli to swap integrals.
      let F : E × ℝ → ℝ≥0∞ :=
        fun z => ‖grad (E := E) f.1 (z.1 + z.2 • a)‖ₑ ^ (2 : ℝ)
      have hmeas :
          AEMeasurable
            F (μ.prod (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) := by
        have hgrad : Continuous (grad (E := E) f.1) := continuous_grad (E := E) (f := f.1) f.2.1
      ...
      have hTonelli :
          (∫⁻ x, ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) ∂μ) =
            ∫⁻ t, ∫⁻ x, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂μ ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) := by
        -- Tonelli in both orders, via the product measure.
        have hprod :
            (∫⁻ z, F z ∂μ.prod (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) =
              ∫⁻ x, ∫⁻ t, F (x, t) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) ∂μ :=
          MeasureTheory.lintegral_prod (μ := μ) (ν := (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) F hmeas
        have hprod_symm :
            (∫⁻ z, F z ∂μ.prod (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) =
              ∫⁻ t, ∫⁻ x, F (x, t) ∂μ ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) :=
          MeasureTheory.lintegral_prod_symm (μ := μ) (ν := (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) F hmeas
        calc
          (∫⁻ x, ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) ∂μ)
              = ∫⁻ z, F z ∂μ.prod (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) := by
                  simpa [F] using! hprod.symm
          _ = ∫⁻ t, ∫⁻ x, F (x, t) ∂μ ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) := hprod_symm
          _ = ∫⁻ t, ∫⁻ x, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂μ ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) := by
                  simp [F]
      -- Now use measure-preserving translation in `x` and evaluate the `t`-integral.
      have hShift :
          (∫⁻ t, ∫⁻ x, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂μ ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) =
            ∫⁻ t, (∫⁻ x, ‖grad (E := E) f.1 x‖ₑ ^ (2 : ℝ) ∂μ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) := by
      ...
      have hEval :
          (∫⁻ t, (∫⁻ x, ‖grad (E := E) f.1 x‖ₑ ^ (2 : ℝ) ∂μ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) =
            (∫⁻ x, ‖grad (E := E) f.1 x‖ₑ ^ (2 : ℝ) ∂μ) := by
        -- `vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI` has total mass `1`.
        simp [vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI, Measure.restrict_apply, Real.volume_Icc]
      ...
      have hInt :
        ...
        calc
          (∫⁻ x, ‖f.1 (x + a) - f.1 x‖ₑ ^ (2 : ℝ) ∂μ)
              ≤ ∫⁻ x, ‖a‖ₑ ^ (2 : ℝ) *
                    ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) ∂μ := by
                refine MeasureTheory.lintegral_mono ?_
                intro x
                exact hpt x
          _ = ‖a‖ₑ ^ (2 : ℝ) *
                (∫⁻ x, ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ) ∂μ) := by
                ...
                have hInner :
                  ...
                  simpa [F] using! (hmeas.lintegral_prod_right' (μ := μ) (ν := (vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)))
                simpa [mul_assoc] using!
                  (MeasureTheory.lintegral_const_mul'' (μ := μ) (r := ‖a‖ₑ ^ (2 : ℝ))
                    (f := fun x : E =>
                      ∫⁻ t, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) hInner)
          _ = ‖a‖ₑ ^ (2 : ℝ) *
                (∫⁻ t, ∫⁻ x, ‖grad (E := E) f.1 (x + t • a)‖ₑ ^ (2 : ℝ) ∂μ ∂(vendorAnalysisFunctionalSpacesSobolevEuclideanTranslationEstimateL2_μI : Measure ℝ)) := by
