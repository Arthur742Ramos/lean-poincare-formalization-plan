...
normed-comm-ring-valued `C^{0,α}` controls, finite `Pi` packaging across
...
controlled range, direct parabolic `C^{0,1}` lifts of time-independent spatial
Lipschitz functions on the spatial projection, bounded `C^{0,α}` composition
under range or
