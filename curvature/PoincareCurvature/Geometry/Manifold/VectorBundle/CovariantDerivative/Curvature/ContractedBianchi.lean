...
The final two theorems are the contracted second Bianchi identity and the vanishing divergence of
the Einstein tensor for a torsion-free metric-compatible tangent connection.
-/
