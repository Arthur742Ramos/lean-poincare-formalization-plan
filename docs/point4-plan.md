...
determinant lower bound, with the inverse-Gram and schematic RHS handoffs now also accepting
those same Gram-entry input forms and the inverse-Gram vector/vector-inverse product handoffs
now also accepting the spatial-Hölder Gram-entry form, quantitative finite-family inverse-Gram
