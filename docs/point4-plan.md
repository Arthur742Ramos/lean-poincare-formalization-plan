...
Gram and schematic RHS bridges at every `0 ≤ α ≤ 1`, fixed-constant and
existential closed-ball and closed-cylinder spatial-Lipschitz inverse-Gram and
schematic RHS variants, and
...
applicable; the inverse-Gram, inverse-principal, and schematic RHS
bounded-difference, comparison, and entrywise-difference bridges, plus the
inverse-Gram Christoffel bounded-difference bridge, now also have
unit-diameter, closed-ball, and
