...
packages the canonical stationary local solution attached to
  ...
  Gram and schematic RHS bridges at every `0 ≤ α ≤ 1`, closed-ball and
  closed-cylinder spatial-Lipschitz inverse-Gram and schematic RHS variants,
  and compact quantitative inverse Gram, inverse-Gram action/bilinear,
