...
packages the canonical stationary local solution attached to
  ...
  inverse-matrix, matrix-product, inverse-principal entry, and
  inverse-Christoffel metric-side matrix-norm Lipschitz constants, plus pointwise
  quadratic-Christoffel contraction
