...
packages the canonical stationary local solution attached to
  ...
  contractions, inverse-principal contractions `g^{ab}H_abij`, and schematic
  RHS bridges at every `0 ≤ α ≤ 1`,
  ...
  inverse-principal, and schematic RHS variants, and compact quantitative inverse Gram,
