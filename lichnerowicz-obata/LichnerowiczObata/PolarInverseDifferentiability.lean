...
differentiable at every point of the open target, without choosing polar
coordinates in the conclusion. -/
theorem exists_differentiable_polar_inverse_on_target
    (J : Opens ℝ) (U : Opens M)
    (Q : Metric.sphere (0 : P) 1 × J ≃ₜ U)
    (q₀ : Metric.sphere (0 : P) 1 × J) (Φ : P × ℝ → M)
    (hQ : ∀ q, (Q q : M) = Φ (q.1, q.2))
  ...
  obtain ⟨e, hs, ht, he, hd⟩ :=
    exists_differentiable_polar_inverse J U Q q₀ Φ hQ hDim hjet
