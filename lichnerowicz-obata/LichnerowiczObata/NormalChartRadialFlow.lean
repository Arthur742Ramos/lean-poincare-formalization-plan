...
public import LichnerowiczObata.ObataNormalRay
public import LichnerowiczObata.IntrinsicNormalMetric
...
twice continuously differentiable map of Cartesian tangent vectors. -/
def HasRadialPoleModel {P : Type*} [NormedAddCommGroup P] [NormedSpace ℝ P]
