...
lemma vendorAnalysisFunctionalSpacesSobolevEuclideanL2CompactnessTranslationIntegral_kernelMeasure_compl_ball_eq_zero_of_tsupport_subset {δ : ℝ}
...
theorem integral_norm_sq_translateL2_sub_le_sq_of_tsupport_subset_ball
  ...
  have hμzero : μ ((Metric.ball (0 : E) δ)ᶜ) = 0 := by
    simpa [μ] using! vendorAnalysisFunctionalSpacesSobolevEuclideanL2CompactnessTranslationIntegral_kernelMeasure_compl_ball_eq_zero_of_tsupport_subset (E := E) (ψ := ψ) hψsupp
